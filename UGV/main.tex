\documentclass[journal,15pt,twocolumn,tikz, border=5mm]{IEEEtran}
...
\usepackage{xcolor}  
\tikzset{block/.style={draw, thick, text width=1cm , minimum height=3cm, align=center},   
line/.style={-latex}     
}  
...
%\def{Future Wireless Communication (FWC)}
\maketitle
\newpage
\bigskip
...
\includegraphics[width=0.5\textwidth]{BOARD1.jpg}
...
]  (controller) {M4-F FPU  MPU 80MHZ};

\node [draw,
 fill=brown,
 minimum width=2cm,
 minimum height=0.5cm,
  below right=2cm and 4cm   of controller,
  text width=2cm,align=center
]  (controller1) {SRAM 0 \\ 32 X 8 X4};

\node [draw,
 fill=brown,
 minimum width=2cm,
 minimum height=0.5cm,
  below right=3cm and 4cm   of controller,
  text width=2cm,align=center
]  (controller2) {SRAM 1 \\ 32 X 8 X4};

\node [draw,
 fill=brown,
 minimum width=2cm,
 minimum height=0.5cm,
  below right=4cm and 4cm   of controller,
  text width=2cm,align=center
]  (controller3) {SRAM 2 \\ 32 X 8 X4};

\node [draw,
 fill=yellow,
 minimum width=2cm,
 minimum height=0.5cm,
  below right=6cm and 4cm   of controller,
  text width=2cm,align=center
]  (controller4) {SRAM 3 \\ 32 X 8 X4};

\node [draw,
 fill=green,
 minimum width=0.1cm,
 minimum height=0.5cm,
  below right=11cm and -3cm   of controller,
...
\node [draw,
 ...
 minimum height=0.9cm,
  below right=11cm and -1.3cm   of controller,
  text width=0.7cm,align=center
]  (controller6) {TLC};
...
\node [draw,
 ...
 minimum width=0.1cm,
 minimum height=0.9cm,
  below right=11cm and -0.2cm   of controller,
...
\node [draw,
 ...
 minimum width=2cm,
 minimum height=1cm,
  below right=15cm and 1cm of controller,
  text width=0.8cm,align=center
]  (controller9) {FPGA};
...
\node [draw,
 ...
 minimum width=1cm, 
 minimum height=7cm,
 below right=-1.2cm and 1.5cm   of controller
] (system) {\begin{turn}{90} 
AHB-M4 \\
32bit @ 80MHZ
\end{turn}};
...
\node [draw,
 ...
 minimum width=1cm, 
 minimum height=7cm, 
 below right= 7cm and 1.5cm of controller
]  (sensor) {{\begin{turn}{90} 
AHB-AON \\
32bit @ 10MHZ
\end{turn}}};
...
\draw[-stealth] (controller.east) -- (system.west) 
 node[midway ,right]{};
 \draw[-stealth] (system.east) -- (controller1.west) 
 node[midway ,right]{};
 \draw[-stealth] (system.east) -- (controller2.west) 
 node[midway ,right]{};
  \draw[-stealth] (system.east) -- (controller3.west) 
 node[midway ,right]{};
  \draw[-stealth] (system.east) -- (controller4.west) 
 node[midway ,right]{};
 \draw[-stealth] (sensor.east) -- (controller4.west) 
 node[midway ,right]{};

 \draw[-stealth] (controller8.east) -- (sensor.west) 
 node[midway ,right]{};

 \draw[-stealth] (sensor.south) -- (controller9.north) 
 node[midway ,right]{};
\draw[stealth-stealth] (system.south) -- (sensor.north) 
 node[midway,above]{};
\end{tikzpicture}
\vspace{0.5cm}
%\includegraphics[width=0.5\textwidth]{eos3.jpg}
\centerline{Figure 2 - EOS S3 Architecture}
\
...
\vspace{0.25cm}
\begin{tikzpicture}  
\node[block, fill=orange] (d)  {Wish
bone
Bus};  
\node[block, left=of d, fill= orange ] (e)  {AHB Slave};  
\node[draw, fill=pink, fill opacity=0.3,inner xsep=4mm,inner  
     ysep=4mm,fit=(d)(e),label={90:AHB-to-Wishbone Bridge}](f){}; 
\node[block, left=of f, fill= none ] (g) {EOS System}; 
\node[block, right=of f, fill= none ] (h)  {FPGA Fabric};  
\draw[line] (e)-- (d);  
\draw[line] (g)--(e); 
\draw[line] (d)--(h);
...
\includegraphics[width=0.5\textwidth]{car2.jpg}
